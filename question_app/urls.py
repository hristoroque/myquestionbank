...
urlpatterns = [
    ...
    path('<str:username>/themes/<int:theme_pk>/<int:question_pk>/update',views.question_update,name='question_update'),
    path('<str:username>/themes/<int:theme_pk>/<int:question_pk>/delete',views.delete_question,name='delete_question'),
    path('<str:username>/themes/<int:theme_pk>/<int:question_pk>/updating',views.update_question,name='update_question'),
